...
function onStreamEvent(e) {
    ...
    switch (e.type) {
        ...
        case google.ima.dai.api.StreamEvent.Type.AD_PROGRESS:
            let obj = e.A.adProgressData;
            //adBreakDuration,adPosition,totalAds
            let duration = document.querySelector('#duration');

            duration.innerHTML = "Skip " + Math.trunc(obj.duration - obj.currentTime);
            console.log('Ad Duration', obj.duration,obj.currentTime,obj.totalAds);
